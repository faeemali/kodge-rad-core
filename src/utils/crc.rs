const CRC16_TAB: [u16; 256] = [0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7,
...
//initial crc value must be 0xFFFF
pub fn crc16_for_byte(curr_crc: u16, data: u8) -> u16 {
    let shifted_l8 = curr_crc << 8;
    let shifted_r8 = curr_crc >> 8;
    let table_pos = ((shifted_r8 ^ (data as u16)) & 0x00FF) as usize;
    let table_item = CRC16_TAB[table_pos];
